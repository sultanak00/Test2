...
class Test(unittest.TestCase):
    ...
    def test_x1(self): #it checks the main method
        self.assertRaises(None, short.process_input("","",1,3))
    
    def test_y1(self): #it checks the main method
        self.assertRaises(None, short.process_input(1,"skdk",2,3))
               
    def test_x2(self): #it checks the main method
        self.assertRaises(None, short.process_input(1,1,"alkdj",5))
        
    def test_y2(self): #it checks the main method
        self.assertRaises(None, short.process_input(1,1,5,"a"))
